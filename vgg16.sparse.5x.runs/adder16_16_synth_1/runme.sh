...
HD_PWD='/home/dai/vgg16.sparse.5x/vgg16.sparse.5x.runs/adder16_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder16_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder16_16.tcl
