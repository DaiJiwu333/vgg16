...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_9 -L xbip_pipe_v3_0_5 -L xbip_bram18k_v3_0_5 -L mult_gen_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot mult8_8 xil_defaultlib.mult8_8 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult8_8 -key {Behavioral:sim_1:Functional:mult8_8} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult8_8.wdb xsim.dir)
