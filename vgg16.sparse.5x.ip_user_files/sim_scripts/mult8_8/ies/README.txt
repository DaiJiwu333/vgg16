...
#
# Generated by export_simulation on Tue May 21 07:24:12 EDT 2019
#
################################################################################
...
'-reset_run' switch to the './mult8_8.sh' script.

./mult8_8.sh -reset_run
...
./mult8_8.sh -noclean_files

For more information on the script, please type './mult8_8.sh -help'.
